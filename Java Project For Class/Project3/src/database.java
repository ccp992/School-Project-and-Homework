...
public class database {
	...
	/**
	 * get fruit list from ItemList
	 * @return
	 */
	public ArrayList<String> displayFruit() {
		return ProduceList.DisplayFruit();
		
	}
	/**
	 * get vegetable list from ItemList
	 * @return
	 */
	public ArrayList<String> displayVegetable() {
		return ProduceList.DisplayVegetable();	
	}
	/**
	 * get all item from ItemList
	 * @return
	 */
	public ArrayList<String> displayAll() {
		return ProduceList.DisplayAll();
		
	}
	
	public int getLength() {
		return ProduceList.getLength();
	}
